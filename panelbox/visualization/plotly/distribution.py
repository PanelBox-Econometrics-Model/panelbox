    ...
    def _create_figure(self, data: Dict[str, Any], **kwargs) -> go.Figure:
        ...
        if groups is not None:
            ...
            fig.add_trace(go.Histogram(
                ...
                histnorm='probability density' if show_kde or show_normal else '',
                marker_color=self.theme.color_scheme[0] if self.theme and self.theme.color_scheme else None
            ))
        ...
        fig.update_layout(
            ...
            yaxis_title=data.get('yaxis_title', 'Frequency' if not (show_kde or show_normal) else 'Density'),
