"""
Validation Report with Interactive Charts
==========================================

Generates a complete validation report with interactive Plotly visualizations.
"""
...
def main():
    print("=" * 80)
    print("VALIDATION REPORT WITH INTERACTIVE CHARTS")
    print("=" * 80)
    print()
    ...
    # 4. Transform validation results WITH CHARTS
    print("Transforming validation results with interactive charts...")
    transformer = ValidationTransformer(validation)

    # Use new visualization system to include charts
    report_data = transformer.transform(
        include_charts=True, use_new_visualization=True  # This will pre-render charts as HTML
    )

    # Count charts
    n_charts = len(report_data.get("charts", {})) if report_data.get("charts") else 0
    print(f"  ✅ Data transformed with {n_charts} charts")
    print()
    ...
    # 6. Save report
    print("Saving report...")
    output_path = Path("/home/guhaase/projetos/panelbox/validation_report_with_charts.html")
    ...
    # 7. Summary
    print("=" * 80)
    print("✅ VALIDATION REPORT WITH CHARTS GENERATED SUCCESSFULLY")
    print("=" * 80)
    print()
