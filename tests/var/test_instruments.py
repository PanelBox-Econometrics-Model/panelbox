...
class TestInstrumentMatrixStructure:
    ...
    def test_all_instruments_structure(self):
        ...
        Z, _meta = builder.construct_instruments(df, value_cols=["y1", "y2"])
    ...
    def test_collapsed_reduces_instruments(self):
        ...
        _Z_all, meta_all = builder_all.construct_instruments(df, value_cols=["y1", "y2"])
        ...
        builder_collapsed = PanelVARInstruments(
            ...
            max_instruments=3,  # Limit to 3 lags
        )
        _Z_collapsed, meta_collapsed = builder_collapsed.construct_instruments(
            df, value_cols=["y1", "y2"]
        )
...
class TestMaxInstruments:
    ...
    def test_max_instruments_all(self):
        ...
        _Z_unlimited, meta_unlimited = builder_unlimited.construct_instruments(
            df, value_cols=["y1", "y2"]
        )
...
class TestEdgeCases:
    ...
    def test_proliferation_warning(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            _Z, _meta = builder.construct_instruments(df, value_cols=["y1", "y2"])
