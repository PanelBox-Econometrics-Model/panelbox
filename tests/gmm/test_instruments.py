...
import numpy as np
import pandas as pd
from panelbox.gmm.instruments import InstrumentBuilder, InstrumentSet, InstrumentStyle, EquationType
...
class TestInstrumentBuilder:
    ...
    def test_iv_style_instruments_basic(self, simple_panel):
        ...
        Z = builder.create_iv_style_instruments(
            var='x',
            min_lag=0,
            max_lag=0,
            equation='diff'
    ...
    def test_combine_instruments(self, simple_panel):
        ...
        Z1 = builder.create_gmm_style_instruments(
            var='y', min_lag=2, max_lag=99, collapse=True
        )
        Z2 = builder.create_iv_style_instruments(
            var='x', min_lag=0, max_lag=0
        )
    ...
    def test_instrument_count_analysis_warning(self, simple_panel):
        ...
        Z = builder.create_gmm_style_instruments(
            var='y', min_lag=2, max_lag=99, collapse=False
        )
