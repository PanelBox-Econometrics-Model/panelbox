...
class TestTestResult:
    ...
    def test_ar2_conclusion_reject(self):
        ...
        result = TestResult(
            name="AR(2) test", statistic=2.8, pvalue=0.005, distribution="normal"  # Below 0.10
        )
        assert result.conclusion == "REJECT"
    ...
    def test_str_with_df(self):
        ...
        result = TestResult(name="Hansen J-test", statistic=10.5, pvalue=0.15, df=5)
        s = str(result)
    ...
    def test_str_without_df(self):
        ...
        result = TestResult(name="AR(1) test", statistic=-2.5, pvalue=0.01, df=None)
        s = str(result)
...
class TestGMMResults:
    ...
    def test_to_latex_custom_caption(self, basic_results):
        ...
        latex = basic_results.to_latex(caption="My Custom Caption", label="tab:my_model")
