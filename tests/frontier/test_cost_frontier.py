...
def test_cost_frontier_sign_convention():
    ...
    # Gerar dados
    df, _true_params = generate_cost_frontier_data(n=100, sigma_u=0.3, seed=123)
...
def test_panel_cost_frontier_pittlee():
    ...
    df, _true_params = generate_panel_cost_data(
...
def test_cost_frontier_parameter_recovery():
    ...
    # Gerar dados
    df, _true_params = generate_cost_frontier_data(
