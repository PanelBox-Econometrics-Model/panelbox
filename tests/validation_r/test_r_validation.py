...
class TestPooledLogitVsR:
    ...
    def test_coefficients(self, data, r_results):
        ...
        for var in ["x1", "x2"]:
            assert np.isclose(result.params[var], r_results["coef"][var], rtol=COEF_RTOL), (
    ...
    def test_standard_errors(self, data, r_results):
        ...
        for var in ["x1", "x2"]:
            assert np.isclose(result.std_errors[var], r_results["se"][var], rtol=SE_RTOL), (
    ...
    def test_loglikelihood(self, data, r_results):
        ...
        assert np.isclose(result.llf, r_results["loglik"], rtol=0.001), (
    ...
    def test_marginal_effects(self, data, r_results):
        ...
        for var in ["x1", "x2"]:
            assert np.isclose(ame.marginal_effects[var], r_ame[var], rtol=ME_RTOL), (
...
class TestPooledProbitVsR:
    ...
    def test_loglikelihood(self, data, r_results):
        ...
        assert np.isclose(result.llf, r_results["loglik"], rtol=0.001), "Log-likelihood mismatch"
...
class TestFELogitVsR:
    ...
    def test_loglikelihood(self, data, r_results):
        ...
        assert np.isclose(result.llf, r_results["loglik"], rtol=0.001), (
            "FE Logit log-likelihood mismatch"
        )
...
class TestPooledTobitVsR:
    ...
    def test_sigma(self, data, r_results):
        ...
        assert np.isclose(result.scale, r_results["sigma"], rtol=COEF_RTOL), (
...
class TestPooledPoissonVsR:
    ...
    def test_loglikelihood(self, data, r_results):
        ...
        assert np.isclose(result.llf, r_results["loglik"], rtol=0.001), (
            "Poisson log-likelihood mismatch"
        )
...
class TestFEPoissonVsR:
    ...
    def test_loglikelihood(self, data, r_results):
        ...
        assert np.isclose(result.llf, r_results["loglik"], rtol=0.001), (
            "FE Poisson log-likelihood mismatch"
        )
...
class TestNegativeBinomialVsR:
    ...
    def test_theta(self, data, r_results):
        ...
        assert np.isclose(
            result.theta,
            r_results["theta"],
            rtol=0.15,  # Theta pode ter mais variação
    ...
    def test_loglikelihood(self, data, r_results):
        ...
        assert np.isclose(result.llf, r_results["loglik"], rtol=0.001), (
            "NegBin log-likelihood mismatch"
        )
