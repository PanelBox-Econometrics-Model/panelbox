...
class TestDynamicBinaryPanelValidation:
    ...
    def test_random_effects_identification(self):
        ...
        assert abs(rho_hat - self.rho) < 0.3, (
    ...
    def test_time_averages_significance(self):
        ...
        assert np.any(np.abs(result.delta_xbar) > 0.05), (
