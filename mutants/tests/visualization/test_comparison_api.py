...
class TestCreateComparisonChartsBasic:
    ...
    def test_single_chart_type(self, mock_results):
        ...
        charts = create_comparison_charts(mock_results, charts=["coefficients"])
    ...
    def test_all_chart_types(self, mock_results):
        ...
        charts = create_comparison_charts(
            mock_results, charts=["coefficients", "fit_comparison", "ic_comparison"]
        )
...
class TestCreateComparisonChartsThemes:
    ...
    def test_professional_theme(self, mock_results):
        ...
        charts = create_comparison_charts(mock_results, theme="professional")
    ...
    def test_academic_theme(self, mock_results):
        ...
        charts = create_comparison_charts(mock_results, theme="academic")

        assert charts is not None

    def test_presentation_theme(self, mock_results):
        """Test with presentation theme."""
        charts = create_comparison_charts(mock_results, theme="presentation")

        assert charts is not None

    def test_theme_object(self, mock_results):
        """Test with theme object."""
        charts = create_comparison_charts(mock_results, theme=PROFESSIONAL_THEME)

        assert charts is not None

    def test_no_theme(self, mock_results):
        """Test with no theme."""
        charts = create_comparison_charts(mock_results, theme=None)
...
class TestCreateComparisonChartsOptions:
    ...
    def test_with_variable_subset(self, mock_results):
        ...
        charts = create_comparison_charts(
            mock_results, charts=["coefficients"], variables=["x1", "x2"]
        )
    ...
    def test_with_confidence_level(self, mock_results):
        ...
        charts = create_comparison_charts(
            [mock_results[0]], charts=["forest_plot"], confidence_level=0.99
        )
    ...
    def test_include_html_false(self, mock_results):
        ...
        charts = create_comparison_charts(mock_results, include_html=False)
    ...
    def test_include_html_true(self, mock_results):
        ...
        charts = create_comparison_charts(mock_results, include_html=True)
...
class TestCreateComparisonChartsEdgeCases:
    ...
    def test_two_models(self, mock_results):
        ...
        charts = create_comparison_charts(
            mock_results[:2], charts=["coefficients", "fit_comparison", "ic_comparison"]
        )
    ...
    def test_empty_charts_list(self, mock_results):
        ...
        charts = create_comparison_charts(mock_results, charts=[])
    ...
    def test_invalid_chart_type(self, mock_results):
        ...
        charts = create_comparison_charts(
            mock_results, charts=["coefficients", "invalid_chart_type"]
        )
    ...
    def test_missing_attributes(self):
        ...
        charts = create_comparison_charts([results], charts=["forest_plot"])
...
class TestCreateComparisonChartsIntegration:
    ...
    def test_charts_consistency(self, mock_results):
        ...
        for chart_type in chart_types:
            charts = create_comparison_charts(mock_results, charts=[chart_type])
    ...
    def test_different_themes_produce_different_outputs(self, mock_results):
        ...
        charts_prof = create_comparison_charts(
            mock_results, theme="professional", include_html=True
        )

        charts_acad = create_comparison_charts(mock_results, theme="academic", include_html=True)
