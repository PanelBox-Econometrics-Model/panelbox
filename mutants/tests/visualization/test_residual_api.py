...
class TestCreateResidualDiagnosticsBasic:
    ...
    def test_specific_charts(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=["qq_plot", "residual_vs_fitted"])
    ...
    def test_single_chart(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=["qq_plot"])
...
class TestCreateResidualDiagnosticsThemes:
    ...
    def test_professional_theme(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, theme="professional", charts=["qq_plot"])

        assert len(charts) > 0

    def test_academic_theme(self, mock_results):
        """Test with academic theme."""
        charts = create_residual_diagnostics(mock_results, theme="academic", charts=["qq_plot"])

        assert len(charts) > 0

    def test_presentation_theme(self, mock_results):
        """Test with presentation theme."""
        charts = create_residual_diagnostics(mock_results, theme="presentation", charts=["qq_plot"])

        assert len(charts) > 0

    def test_no_theme(self, mock_results):
        """Test with no theme."""
        charts = create_residual_diagnostics(mock_results, theme=None, charts=["qq_plot"])
...
class TestCreateResidualDiagnosticsOutputFormats:
    ...
    def test_chart_objects(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=["qq_plot"], include_html=False)
    ...
    def test_html_strings(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=["qq_plot"], include_html=True)
    ...
    def test_html_validity(self, mock_results):
        ...
        charts = create_residual_diagnostics(
            mock_results, charts=["qq_plot", "residual_vs_fitted"], include_html=True
        )

        for _chart_name, html in charts.items():
            assert len(html) > 100
...
class TestCreateResidualDiagnosticsOptions:
    ...
    def test_custom_config(self, mock_results):
        ...
        config = {"qq_plot": {"title": "Custom Q-Q Plot", "width": 1200, "height": 900}}

        charts = create_residual_diagnostics(mock_results, charts=["qq_plot"], config=config)

        assert len(charts) > 0

    def test_multiple_configs(self, mock_results):
        """Test configs for multiple charts."""
        config = {"qq_plot": {"title": "Q-Q Plot"}, "residual_vs_fitted": {"title": "Residuals"}}

        charts = create_residual_diagnostics(
            mock_results, charts=["qq_plot", "residual_vs_fitted"], config=config
        )
...
class TestCreateResidualDiagnosticsIntegration:
    ...
    def test_end_to_end_all_charts(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, theme="professional")
    ...
    def test_end_to_end_html_output(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, theme="academic", include_html=True)
    ...
    def test_all_chart_types(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=all_charts)
    ...
    def test_theme_applied_to_all(self, mock_results):
        ...
        charts = create_residual_diagnostics(
            mock_results, theme="professional", charts=["qq_plot", "residual_vs_fitted"]
        )
...
class TestCreateResidualDiagnosticsErrorHandling:
    ...
    def test_invalid_chart_name(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=["qq_plot", "invalid_chart"])
    ...
    def test_missing_data_continues(self):
        ...
        charts = create_residual_diagnostics(results, charts=["qq_plot", "residual_vs_fitted"])
    ...
    def test_empty_chart_list(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=[])
...
class TestCreateResidualDiagnosticsEdgeCases:
    ...
    def test_very_small_sample(self):
        ...
        charts = create_residual_diagnostics(results, charts=["qq_plot"])
    ...
    def test_perfect_fit(self):
        ...
        charts = create_residual_diagnostics(results, charts=["residual_distribution"])
...
class TestCreateResidualDiagnosticsIndividualCharts:
    ...
    def test_residual_vs_fitted_creation(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=["residual_vs_fitted"])
    ...
    def test_scale_location_creation(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=["scale_location"])
    ...
    def test_residual_vs_leverage_creation(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=["residual_vs_leverage"])
    ...
    def test_timeseries_creation(self, mock_results):
        ...
        charts = create_residual_diagnostics(mock_results, charts=["residual_timeseries"])

        assert isinstance(charts["residual_timeseries"], ResidualTimeSeriesPlot)

    def test_distribution_creation(self, mock_results):
        """Test distribution creation."""
        charts = create_residual_diagnostics(mock_results, charts=["residual_distribution"])
