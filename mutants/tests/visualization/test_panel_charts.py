...
from panelbox.visualization.themes import ACADEMIC_THEME, PRESENTATION_THEME, PROFESSIONAL_THEME
...
def sample_panel_structure_data():
    ...
    return {"entities": entities, "time_periods": time_periods, "presence_matrix": presence_matrix}
...
def sample_panel_dataframe():
    ...
    index = pd.MultiIndex.from_product([entities_idx, time_idx], names=["entity", "time"])
    ...
    return pd.DataFrame(
        {"var1_high_between": var1, "var2_high_within": var2, "var3_balanced": var3}, index=index
    )
...
class TestEntityEffectsPlot:
    ...
    def test_sort_by_magnitude(self, sample_entity_effects_data):
        ...
        chart = EntityEffectsPlot()
        fig = chart._create_figure(sample_entity_effects_data, sort_by="magnitude")

        assert fig is not None
        # Verify data is sorted
        effects = sample_entity_effects_data["effect"]
        sorted(effects, key=abs, reverse=True)
    ...
    def test_without_confidence_intervals(self, sample_entity_effects_data):
        ...
        chart = EntityEffectsPlot()
        fig = chart._create_figure(sample_entity_effects_data, show_confidence=False)
    ...
    def test_empty_data(self):
        ...
        data = {"entity_id": [], "effect": [], "std_error": []}
...
class TestTimeEffectsPlot:
    ...
    def test_with_confidence_bands(self, sample_time_effects_data):
        ...
        chart = TimeEffectsPlot()
        fig = chart._create_figure(sample_time_effects_data, show_confidence=True)
    ...
    def test_highlight_significant(self, sample_time_effects_data):
        ...
        chart = TimeEffectsPlot()
        fig = chart._create_figure(sample_time_effects_data, highlight_significant=True)
...
class TestBetweenWithinPlot:
    ...
    def test_creation_stacked(self, sample_between_within_data):
        ...
        fig = chart._create_figure(sample_between_within_data, chart_type="stacked")
    ...
    def test_creation_side_by_side(self, sample_between_within_data):
        ...
        chart = BetweenWithinPlot()
        fig = chart._create_figure(sample_between_within_data, chart_type="side_by_side")
    ...
    def test_creation_scatter(self, sample_between_within_data):
        ...
        chart = BetweenWithinPlot()
        fig = chart._create_figure(sample_between_within_data, chart_type="scatter")
    ...
    def test_with_percentages(self, sample_between_within_data):
        ...
        fig = chart._create_figure(
            sample_between_within_data, chart_type="stacked", show_percentages=True
        )
    ...
    def test_all_chart_types(self, sample_between_within_data):
        ...
        for chart_type in ["stacked", "side_by_side", "scatter"]:
            fig = chart._create_figure(sample_between_within_data, chart_type=chart_type)
            assert fig is not None
    ...
    def test_single_variable(self):
        ...
        data = {"variables": ["wage"], "between_var": [15.5], "within_var": [5.2]}
    ...
    def test_invalid_chart_type(self, sample_between_within_data):
        ...
        fig = chart._create_figure(sample_between_within_data, chart_type="invalid_type")
...
class TestPanelStructurePlot:
    ...
    def test_with_statistics(self, sample_panel_structure_data):
        ...
        chart = PanelStructurePlot()
        fig = chart._create_figure(sample_panel_structure_data, show_statistics=True)
    ...
    def test_highlight_complete(self, sample_panel_structure_data):
        ...
        chart = PanelStructurePlot()
        fig = chart._create_figure(sample_panel_structure_data, highlight_complete=True)
...
class TestPanelChartsEdgeCases:
    ...
    def test_single_time_period(self):
        ...
        data = {"time": [2000], "effect": [0.5], "std_error": [0.1]}
