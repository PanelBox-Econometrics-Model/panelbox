...
class TestQQPlot:
    ...
    def test_standardized_residuals(self, sample_residuals):
        ...
        chart = QQPlot()
        chart.create({"residuals": sample_residuals, "standardized": True})
    ...
    def test_confidence_bands(self, sample_residuals):
        ...
        chart = QQPlot()
        chart.create(
            {"residuals": sample_residuals, "show_confidence": True, "confidence_level": 0.95}
        )
    ...
    def test_no_confidence_bands(self, sample_residuals):
        ...
        chart = QQPlot()
        chart.create({"residuals": sample_residuals, "show_confidence": False})
...
class TestResidualVsFittedPlot:
    ...
    def test_creation(self, sample_fitted, sample_residuals):
        ...
        chart.create({"fitted": sample_fitted, "residuals": sample_residuals})
    ...
    def test_with_lowess(self, sample_fitted, sample_residuals):
        ...
        chart = ResidualVsFittedPlot()
        chart.create({"fitted": sample_fitted, "residuals": sample_residuals, "add_lowess": True})
    ...
    def test_without_lowess(self, sample_fitted, sample_residuals):
        ...
        chart = ResidualVsFittedPlot()
        chart.create({"fitted": sample_fitted, "residuals": sample_residuals, "add_lowess": False})
    ...
    def test_with_reference_line(self, sample_fitted, sample_residuals):
        ...
        chart = ResidualVsFittedPlot()
        chart.create(
            {"fitted": sample_fitted, "residuals": sample_residuals, "add_reference": True}
        )
...
class TestResidualVsLeveragePlot:
    ...
    def test_creation(self, sample_residuals, sample_leverage):
        ...
        chart.create({"residuals": sample_residuals, "leverage": sample_leverage})
    ...
    def test_with_cooks_distance(self, sample_residuals, sample_leverage, sample_cooks_d):
        ...
        chart = ResidualVsLeveragePlot()
        chart.create(
            {"residuals": sample_residuals, "leverage": sample_leverage, "cooks_d": sample_cooks_d}
        )
    ...
    def test_without_contours(self, sample_residuals, sample_leverage):
        ...
        chart = ResidualVsLeveragePlot()
        chart.create(
            {"residuals": sample_residuals, "leverage": sample_leverage, "show_contours": False}
        )
    ...
    def test_with_labels(self, sample_residuals, sample_leverage):
        ...
        chart = ResidualVsLeveragePlot()
        chart.create({"residuals": sample_residuals, "leverage": sample_leverage, "labels": labels})
...
class TestResidualTimeSeriesPlot:
    ...
    def test_with_time_index(self, sample_residuals, sample_time_index):
        ...
        chart = ResidualTimeSeriesPlot()
        chart.create({"residuals": sample_residuals, "time_index": sample_time_index})
    ...
    def test_with_bands(self, sample_residuals):
        """Test with ±2σ bands."""
        chart = ResidualTimeSeriesPlot()
        chart.create({"residuals": sample_residuals, "add_bands": True})
    ...
    def test_without_bands(self, sample_residuals):
        """Test without bands."""
        chart = ResidualTimeSeriesPlot()
        chart.create({"residuals": sample_residuals, "add_bands": False})
...
class TestResidualDistributionPlot:
    ...
    def test_with_kde(self, sample_residuals):
        ...
        chart = ResidualDistributionPlot()
        chart.create({"residuals": sample_residuals, "show_kde": True})
    ...
    def test_without_kde(self, sample_residuals):
        ...
        chart = ResidualDistributionPlot()
        chart.create({"residuals": sample_residuals, "show_kde": False})
    ...
    def test_with_normal_overlay(self, sample_residuals):
        ...
        chart = ResidualDistributionPlot()
        chart.create({"residuals": sample_residuals, "show_normal": True})
    ...
    def test_without_normal_overlay(self, sample_residuals):
        ...
        chart = ResidualDistributionPlot()
        chart.create({"residuals": sample_residuals, "show_normal": False})
    ...
    def test_custom_bins(self, sample_residuals):
        ...
        chart = ResidualDistributionPlot()
        chart.create({"residuals": sample_residuals, "bins": 20})
    ...
    def test_auto_bins(self, sample_residuals):
        """Test with auto bins."""
        chart = ResidualDistributionPlot()
        chart.create({"residuals": sample_residuals, "bins": "auto"})
...
class TestPartialRegressionPlot:
    ...
    def test_creation(self):
        ...
        chart.create({"x_resid": x_resid, "y_resid": y_resid})
    ...
    def test_with_variable_name(self):
        ...
        chart = PartialRegressionPlot()
        chart.create({"x_resid": x_resid, "y_resid": y_resid, "variable_name": "GDP"})
    ...
    def test_with_regression_line(self):
        ...
        chart = PartialRegressionPlot()
        chart.create({"x_resid": x_resid, "y_resid": y_resid, "add_regression_line": True})
    ...
    def test_without_regression_line(self):
        ...
        chart = PartialRegressionPlot()
        chart.create({"x_resid": x_resid, "y_resid": y_resid, "add_regression_line": False})
