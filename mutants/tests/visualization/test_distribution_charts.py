...
def sample_dataframe():
    ...
    np.random.seed(42)
    return pd.DataFrame(
        {"value": np.random.normal(0, 1, 150), "category": np.repeat(["X", "Y", "Z"], 50)}
    )
...
class TestHistogramChart:
    ...
    def test_with_kde_overlay(self, sample_values):
        ...
        chart = HistogramChart()
        chart.create({"values": sample_values, "show_kde": True})
    ...
    def test_with_normal_overlay(self, sample_values):
        ...
        chart = HistogramChart()
        chart.create({"values": sample_values, "show_normal": True})
    ...
    def test_custom_bins(self, sample_values):
        ...
        chart = HistogramChart()
        chart.create({"values": sample_values, "nbins": 30})
    ...
    def test_normalized_histogram(self, sample_values):
        ...
        chart = HistogramChart()
        chart.create({"values": sample_values, "histnorm": "probability density"})
    ...
    def test_custom_title(self, sample_values):
        """Test custom title."""
        chart = HistogramChart()
        chart.create({"values": sample_values, "title": "Custom Histogram Title"})
...
class TestKDEChart:
    ...
    def test_with_rug_plot(self, sample_values):
        ...
        chart = KDEChart()
        chart.create({"values": sample_values, "show_rug": True})
    ...
    def test_with_statistics(self, sample_values):
        ...
        chart = KDEChart()
        chart.create({"values": sample_values, "show_mean": True, "show_median": True})
    ...
    def test_filled_kde(self, sample_values):
        """Test filled KDE."""
        chart = KDEChart()
        chart.create({"values": sample_values, "fill": True})
    ...
    def test_custom_bandwidth(self, sample_values):
        ...
        chart = KDEChart()
        chart.create({"values": sample_values, "bandwidth": 0.5})
...
class TestViolinPlotChart:
    ...
    def test_with_box_plot(self, sample_grouped_data):
        ...
        chart = ViolinPlotChart()
        chart.create({**sample_grouped_data, "show_box": True})
    ...
    def test_with_points(self, sample_grouped_data):
        ...
        chart = ViolinPlotChart()
        chart.create({**sample_grouped_data, "show_points": True})
    ...
    def test_horizontal_orientation(self, sample_grouped_data):
        ...
        chart = ViolinPlotChart()
        chart.create({**sample_grouped_data, "orientation": "h"})
    ...
    def test_with_meanline(self, sample_grouped_data):
        ...
        chart = ViolinPlotChart()
        chart.create({**sample_grouped_data, "meanline_visible": True})
...
class TestBoxPlotChart:
    ...
    def test_with_points(self, sample_grouped_data):
        ...
        chart = BoxPlotChart()
        chart.create({**sample_grouped_data, "show_points": "all"})
    ...
    def test_with_outliers_only(self, sample_grouped_data):
        ...
        chart = BoxPlotChart()
        chart.create({**sample_grouped_data, "show_points": "outliers"})
    ...
    def test_with_mean(self, sample_grouped_data):
        ...
        chart = BoxPlotChart()
        chart.create({**sample_grouped_data, "show_mean": True})
    ...
    def test_notched_boxplot(self, sample_grouped_data):
        ...
        chart = BoxPlotChart()
        chart.create({**sample_grouped_data, "notched": True})
