...
def sample_faceted_data():
    ...
    data = {
        "time": np.tile(time, n_entities),
        "values": np.random.randn(n_periods * n_entities) * 2
        + np.repeat(np.arange(n_entities), n_periods),
        "entity_id": np.repeat(entities, n_periods),
    }
...
class TestPanelTimeSeriesChart:
    ...
    def test_with_mean_line(self, sample_panel_data):
        """Test with mean line."""
        chart = PanelTimeSeriesChart()
        chart.create({**sample_panel_data, "show_mean": True})
    ...
    def test_custom_variable_name(self, sample_panel_data):
        ...
        chart = PanelTimeSeriesChart()
        chart.create({**sample_panel_data, "variable_name": "GDP Growth"})
    ...
    def test_custom_title(self, sample_panel_data):
        """Test custom title."""
        chart = PanelTimeSeriesChart()
        chart.create({**sample_panel_data, "title": "Custom Panel Plot"})
...
class TestTrendLineChart:
    ...
    def test_with_moving_average(self, sample_timeseries):
        ...
        chart = TrendLineChart()
        chart.create({**sample_timeseries, "show_moving_average": True, "window": 10})
    ...
    def test_without_moving_average(self, sample_timeseries):
        ...
        chart = TrendLineChart()
        chart.create({**sample_timeseries, "show_moving_average": False})
    ...
    def test_with_trend_line(self, sample_timeseries):
        ...
        chart = TrendLineChart()
        chart.create({**sample_timeseries, "show_trend": True})
    ...
    def test_without_trend_line(self, sample_timeseries):
        ...
        chart = TrendLineChart()
        chart.create({**sample_timeseries, "show_trend": False, "show_moving_average": False})
    ...
    def test_custom_window_size(self, sample_timeseries):
        ...
        chart = TrendLineChart()
        chart.create({**sample_timeseries, "window": 20})
    ...
    def test_with_nan_values(self):
        ...
        data = {"time": pd.date_range("2020-01-01", periods=50), "values": np.random.randn(50)}
...
class TestFacetedTimeSeriesChart:
    ...
    def test_custom_columns(self, sample_faceted_data):
        ...
        chart = FacetedTimeSeriesChart()
        chart.create({**sample_faceted_data, "ncols": 2})
    ...
    def test_shared_yaxis(self, sample_faceted_data):
        ...
        chart = FacetedTimeSeriesChart()
        chart.create({**sample_faceted_data, "shared_yaxis": True})
    ...
    def test_independent_yaxis(self, sample_faceted_data):
        ...
        chart = FacetedTimeSeriesChart()
        chart.create({**sample_faceted_data, "shared_yaxis": False})
    ...
    def test_custom_variable_name(self, sample_faceted_data):
        """Test with custom variable name."""
        chart = FacetedTimeSeriesChart()
        chart.create({**sample_faceted_data, "variable_name": "Temperature"})
    ...
    def test_custom_height(self, sample_faceted_data):
        ...
        chart = FacetedTimeSeriesChart()
        chart.create({**sample_faceted_data, "height": 800})
...
class TestChartIntegration:
    ...
    def test_all_charts_create_html(
        self, sample_panel_data, sample_timeseries, sample_faceted_data
    ):
    ...
    def test_all_charts_create_json(
        self, sample_panel_data, sample_timeseries, sample_faceted_data
    ):
    ...
    def test_panel_data_workflow(self, sample_panel_data):
        ...
        panel_chart.create({**sample_panel_data, "show_mean": True})
