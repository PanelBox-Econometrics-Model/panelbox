...
class TestCorrelationHeatmapChart:
    ...
    def test_with_values_displayed(self, sample_correlation_matrix):
        ...
        chart = CorrelationHeatmapChart()
        chart.create({"correlation_matrix": sample_correlation_matrix, "show_values": True})
    ...
    def test_without_values(self, sample_correlation_matrix):
        ...
        chart = CorrelationHeatmapChart()
        chart.create({"correlation_matrix": sample_correlation_matrix, "show_values": False})
    ...
    def test_mask_diagonal(self, sample_correlation_matrix):
        ...
        chart = CorrelationHeatmapChart()
        chart.create({"correlation_matrix": sample_correlation_matrix, "mask_diagonal": True})
    ...
    def test_mask_upper_triangle(self, sample_correlation_matrix):
        ...
        chart = CorrelationHeatmapChart()
        chart.create({"correlation_matrix": sample_correlation_matrix, "mask_upper": True})
    ...
    def test_threshold_filtering(self, sample_correlation_matrix):
        ...
        chart = CorrelationHeatmapChart()
        chart.create({"correlation_matrix": sample_correlation_matrix, "threshold": 0.3})
    ...
    def test_custom_variable_names(self):
        ...
        chart = CorrelationHeatmapChart()
        chart.create(
            {"correlation_matrix": corr_matrix, "variable_names": ["Income", "Age", "Education"]}
        )
    ...
    def test_custom_title(self, sample_correlation_matrix):
        ...
        chart = CorrelationHeatmapChart()
        chart.create(
            {"correlation_matrix": sample_correlation_matrix, "title": "Custom Correlation Matrix"}
        )
...
class TestPairwiseCorrelationChart:
    ...
    def test_subset_variables(self, sample_dataframe):
        ...
        chart = PairwiseCorrelationChart()
        chart.create({"data": sample_dataframe, "variables": ["A", "B", "C"]})
    ...
    def test_with_groups(self, sample_grouped_dataframe):
        ...
        chart = PairwiseCorrelationChart()
        chart.create(
            {"data": sample_grouped_dataframe, "variables": ["A", "B", "C"], "group": "group"}
        )
    ...
    def test_without_diagonal_histogram(self, sample_dataframe):
        ...
        chart = PairwiseCorrelationChart()
        chart.create({"data": sample_dataframe, "show_diagonal_hist": False})
    ...
    def test_custom_title(self, sample_dataframe):
        """Test custom title."""
        chart = PairwiseCorrelationChart()
        chart.create({"data": sample_dataframe, "title": "Custom Pairwise Plot"})
...
class TestChartIntegration:
    ...
    def test_workflow_correlation_analysis(self, sample_dataframe):
        ...
        heatmap.create({"correlation_matrix": corr_matrix, "show_values": True, "mask_upper": True})
