...
def sample_coefficient_data():
    ...
    return {
        ...
        "coefficients": {"x1": [1.2, 0.8], "x2": [-0.5, -0.3], "x3": [2.1, 1.9]},
        "std_errors": {"x1": [0.3, 0.25], "x2": [0.2, 0.18], "x3": [0.4, 0.35]},
    }
...
class TestCoefficientComparisonChart:
    ...
    def test_with_confidence_intervals(self, sample_coefficient_data):
        ...
        chart = CoefficientComparisonChart()
        chart.create({**sample_coefficient_data, "show_ci": True, "confidence_level": 0.95})
    ...
    def test_without_std_errors(self):
        ...
        data = {
            "models": ["Model 1", "Model 2"],
            "coefficients": {"x1": [1.2, 0.8], "x2": [-0.5, -0.3]},
        }
        chart = CoefficientComparisonChart()
        chart.create(data)
    ...
    def test_single_model(self):
        ...
        data = {
            "models": ["Model 1"],
            "coefficients": {"x1": [1.2], "x2": [-0.5], "x3": [2.1]},
            "std_errors": {"x1": [0.3], "x2": [0.2], "x3": [0.4]},
        }
        chart = CoefficientComparisonChart()
        chart.create(data)
    ...
    def test_custom_title(self, sample_coefficient_data):
        """Test custom title."""
        chart = CoefficientComparisonChart()
        chart.create({**sample_coefficient_data, "title": "Custom Coefficient Comparison"})
...
class TestForestPlotChart:
    ...
    def test_significance_coloring(self, sample_forest_plot_data):
        ...
        chart = ForestPlotChart()
        chart.create({**sample_forest_plot_data, "color_by_significance": True, "alpha": 0.05})
    ...
    def test_sort_by_effect_size(self, sample_forest_plot_data):
        ...
        chart = ForestPlotChart()
        chart.create({**sample_forest_plot_data, "sort_by": "effect_size"})
    ...
    def test_reference_line(self, sample_forest_plot_data):
        ...
        chart = ForestPlotChart()
        chart.create({**sample_forest_plot_data, "show_reference": True})
...
class TestModelFitComparisonChart:
    ...
    def test_single_metric(self):
        ...
        data = {"models": ["Model 1", "Model 2"], "r_squared": [0.65, 0.78]}
        chart = ModelFitComparisonChart()
        chart.create(data)
...
class TestInformationCriteriaChart:
    ...
    def test_highlight_best(self, sample_ic_data):
        ...
        chart = InformationCriteriaChart()
        chart.create({**sample_ic_data, "highlight_best": True})
    ...
    def test_show_delta(self, sample_ic_data):
        ...
        chart = InformationCriteriaChart()
        chart.create({**sample_ic_data, "show_delta": True})
    ...
    def test_subset_criteria(self, sample_ic_data):
        ...
        chart = InformationCriteriaChart()
        chart.create({**sample_ic_data, "criteria": ["aic", "bic"]})

        assert chart.figure is not None

    def test_single_criterion(self):
        """Test with single criterion."""
        data = {"models": ["Model 1", "Model 2", "Model 3"], "aic": [305.2, 270.5, 295.8]}
        chart = InformationCriteriaChart()
        chart.create(data)
