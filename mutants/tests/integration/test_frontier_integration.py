...
def test_complete_workflow(panel_data):
    ...
    print("  ✓ Cross-section estimated successfully")
    ...
    print("  ✓ Pitt-Lee estimated successfully")
    ...
    print("  ✓ True FE estimated successfully")
    ...
    print("  ✓ True RE estimated successfully")
...
def test_import_from_panelbox():
    ...
    try:
        from panelbox import DistributionType, FrontierType, ModelType, SFResult, StochasticFrontier  # noqa: F401
